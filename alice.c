...
//Commented in alicehdr.h
Select con = {{0}, {0}, {0}, {'S', 'C', 'D', 'H'}, {'N', 'H', 'P', 'G', 'I'}};
...
int main(int argc, char const *argv[]) {
    ...
    bool initialCheck;
    bool newRound;
    initial_arguments_check(p, argc, argv);
    initialCheck = true;
    send_to_hub(p, initialCheck, playedCard); /*send acknowledge message*/
    initialCheck = false;
    newRound = false;
    allocate(p);
